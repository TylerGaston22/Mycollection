...
export const CONTENT_TYPES = ['movie', 'tv-show', 'restaurant', 'place'] as const;
export type ContentType = (typeof CONTENT_TYPES)[number];

export const ITEM_STATUSES = ['watched', 'want-to-see'] as const;
export type ItemStatus = (typeof ITEM_STATUSES)[number];

export const DEFAULT_CONTENT_TYPE: ContentType = 'movie';
...
export const STORAGE_KEYS = {
  movies: (userId: string) => `movies-${userId}`,
